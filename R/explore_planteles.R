setwd("C:/Users/Juan/Desktop/ftpsaber/4. Saber11/4. Clasificaci?n de Planteles")
setwd("/media/juan/CA9C44FF9C44E791/Users/Juan/Desktop/ftpsaber/4. Saber11/4. Clasificación de Planteles")
...
nr_cols_prev <- length((unique(sb11$COLE_INST_NOMBRE)))
nr_mpio_prev <-length((unique(sb11$COLE_MPIO_MUNICIPIO)))
nr_dept_prev <-length((unique(sb11$COLE_DEPTO_COLEGIO)))


sb11$COLE_INST_NOMBRE <- sapply(sb11$COLE_INST_NOMBRE, stri_trans_general, "Latin-ASCII")
sb11$COLE_MPIO_MUNICIPIO <- sapply(sb11$COLE_MPIO_MUNICIPIO, stri_trans_general, "Latin-ASCII")
sb11$COLE_DEPTO_COLEGIO <- sapply(sb11$COLE_DEPTO_COLEGIO, stri_trans_general, "Latin-ASCII")

nr_cols_post <- length((unique(sb11$COLE_INST_NOMBRE)))
nr_mpio_post <-length((unique(sb11$COLE_MPIO_MUNICIPIO)))
nr_dept_post <-length((unique(sb11$COLE_DEPTO_COLEGIO)))
...
dbWriteTable(conn = con, name = "planteles_20142_20182", sb11)
